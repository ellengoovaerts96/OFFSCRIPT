...
Do not invent missing details. Use null or unknown. Preserve source language and useful details. Copy phone numbers as printed; do not invent a country code. Return times as HH:MM only when clear. Use openingTime and closingTime for explicitly stated visiting hours, separately from startTime and endTime for the event or opening reception. Never treat a vernissage time as daily opening hours. Preserve split hours or weekday exceptions in the description instead of inventing a continuous opening interval.
