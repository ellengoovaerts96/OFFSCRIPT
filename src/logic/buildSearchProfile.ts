...
const PRODUCT_PATTERNS: SignalPattern[] = [
  ...
  ["continental_breakfast", /\b(continental breakfast|continentaal ontbijt|petit dejeuner continental)\b/],
  ["american_breakfast", /\b(american breakfast|amerikaans ontbijt|petit dejeuner americain)\b/],
  ["grilled_prawns", /\b(grilled prawns|grilled shrimp|gegrilde gamba ?s|gegrilde garnalen|gambas grillees|crevettes grillees)\b/],
