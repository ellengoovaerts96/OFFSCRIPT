...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="/admin-assets/tuuti-dashboard-gsm-180.png">
...
export function renderStagingTest(): string {
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#17201d"><link rel="manifest" href="/admin-assets/manifest.webmanifest?v=2"><link rel="apple-touch-icon" href="/admin-assets/tuuti-dashboard-gsm-180.png"><link rel="icon" type="image/png" href="/admin-assets/tuuti_dashboard_flavicon.png"><title>Test TUUTI · Staging</title><style>
