...
assert.match(html, /rel="manifest" href="\/admin-assets\/manifest\.webmanifest\?v=2"/);
assert.match(html, /rel="apple-touch-icon" sizes="180x180" href="\/admin-assets\/tuuti-dashboard-gsm-180\.png"/);
...
for (const file of ["tuuti_dashboard_gsm_icon.jpg", "tuuti-dashboard-gsm-180.png", "tuuti-dashboard-gsm-192.png", "tuuti-dashboard-gsm-512.png", "tuuti_dashboard_flavicon.png"]) {
